package ineuron.springORM_witoutBOOT;
    ...
    public static void main( String[] args )
    {
		...
		try {
			while (true) {
				...
				case 3:
					List<DTO> students = service.getAllStudents();
					students.forEach(System.out::println);
					break;

				case 4:
					System.out.println("please view all the records");
					List<DTO> student = service.getAllStudents();
				...
				case 5:
					System.out.println("please view all the records");
					List<DTO> studen = service.getAllStudents();
				...
				case 6:
					System.out.println("please view all the records");
					List<DTO> stude = service.getAllStudents();
